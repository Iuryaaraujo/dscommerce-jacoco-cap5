...
public class UserServiceTests {
    ...
    // loadUserByUsername deve retornar UserDetails quando o usuário existir
    @Test
    ...
    // loadUserByUsername deve lançar UsernameNotFoundException quando o usuário não existe
    @Test
    ...
    // autenticado deve retornar usuário quando o usuário existir
    @Test
    ...
    // getMe deve retornar UserDTO quando o usuário estive autenticado
    @Test
    public void getMeShouldReturnUserDTOWhenUserAutheticated() {
...
//        Mockito.doReturn(user).when(service).authenticated();
    ...
    // getMe deve lançar UsernameNotFoundException quando o usuário não está autenticado
    @Test
