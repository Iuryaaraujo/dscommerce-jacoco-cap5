...
public class AuthServiceTests {
    ...
    // próprio cliente = selfClient
    // outro cliente = otherClient
    ...
    // validSelfOrAdmin não deve fazer nada quando o administrador estiver conectado
    @Test
    ...
    // validSelfOrAdmin não deve fazer nada quando proprio cliente estive logado
    @Test
    ...
    // validSelfOrAdmin lança exceção proibida quando outro cliente está logado
    @Test
